...
rem Already in the standard install
rem set PYTHON3PATH=C:\ProgramData\orey\Software\python-3.13.4
rem set PYTHONHOME=%PYTHON3PATH%
rem set PYTHONPATH=%PYTHON3PATH%;%PYTHON3PATH%\Lib;%PYTHON3PATH%\Scripts
