...
if [ $# != 3 ]
then
    echo "rotate-page.sh: Script version 2"
...
# Main process: we rotate the page normally, but lulu may not like it
...
# alternate process for lulu, convert rotated page in image and image to pdf
#  _torotate1212.pdf is the page to transform in image
pdftoppm  _torotate1212.pdf _output1212 -png
# should have the proper A4/US Letter format
img2pdf -o _output1212-1.pdf _output1212-1.png
concat_three_files _before1212.pdf _output1212-1.pdf _after1212.pdf _outputbis1212.pdf

input=$(basename "$1" .pdf)
mv _outputbis1212.pdf ${input}-image.pdf
echo "File ${input}-image.pdf generated (for lulu probably)"

#remove all temporary files
rm _before1212.pdf _torotate1212.pdf _after1212.pdf _output1212-1.png _output1212-1.pdf
