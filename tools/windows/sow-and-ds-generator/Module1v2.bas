...
Sub OpenDocumentAndLoop()
    ...
    If ds Then
        ...
        filename2pdf = Sheet.Cells(6, 2) & CStr(count) & "_" & Sheet.Cells(7, 2) & Sheet.Cells(5, 2) & Sheet.Cells(8, 2) & Sheet.Cells(9, 2) & ".pdf"
    ...
    If ds Then
        ...
        objDoc2.ExportAsFixedFormat OutputFileName:=filename2pdf, ExportFormat:=wdExportFormatPDF
        
        logInTab Master, "Exporting PDF file"
        logInTab Master, "File " & filename2pdf & " saved"
