...
# Usage function
usage () {
    echo "resize-variable-images-blank2.sh: Add margins to variable size images in order to reach a fixed image format"
    echo "---"
    echo "Usage: resize-images-blank2.sh [pattern] [target-width] [target-height] [average-image-width] [average-image-height]"
